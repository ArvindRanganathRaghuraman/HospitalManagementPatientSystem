...
BEGIN
    ...
    ins_minor('Emma',      'Smith',      DATE '2010-03-15',   'F',  'A+',  '6172000001', 'emma.smith@hms.com',       'Boston',      1,   'Robert',   'Smith',     'PARENT',         '6179000001');
    ins_minor('Liam',      'Johnson',    DATE '2009-07-22',   'M',  'B+',  '6172000002', 'liam.johnson@hms.com',     'Cambridge',   4,   'Linda',    'Johnson',   'PARENT',         '6179000002');
    ins_minor('Olivia',    'Williams',   DATE '2011-11-05',   'F',  'O+',  '6172000003', 'olivia.williams@hms.com',  'Somerville',  6,   'Michael',  'Williams',  'LEGAL_GUARDIAN', '6179000003');
    ins_minor('Noah',      'Brown',      DATE '2012-01-18',   'M',  'AB+', '6172000004', 'noah.brown@hms.com',       'Quincy',      7,   'Susan',    'Brown',     'PARENT',         '6179000004');
    ins_minor('Ava',       'Davis',      DATE '2013-05-30',   'F',  'A-',  '6172000005', 'ava.davis@hms.com',        'Medford',     8,   'James',    'Davis',     'PARENT',         '6179000005');
    ins_minor('Elijah',    'Miller',     DATE '2008-09-12',   'M',  'B-',  '6172000006', 'elijah.miller@hms.com',    'Waltham',     9,   'Patricia', 'Miller',    'PARENT',         '6179000006');
    ins_minor('Sophia',    'Wilson',     DATE '2010-12-25',   'F',  'O-',  '6172000007', 'sophia.wilson@hms.com',    'Newton',      10,  'David',    'Wilson',    'LEGAL_GUARDIAN', '6179000007');
    ins_minor('Lucas',     'Moore',      DATE '2014-04-08',   'M',  'A+',  '6172000008', 'lucas.moore@hms.com',      'Brookline',   11,  'Barbara',  'Moore',     'PARENT',         '6179000008');
    ins_minor('Mia',       'Taylor',     DATE '2011-08-19',   'F',  'B+',  '6172000009', 'mia.taylor@hms.com',       'Malden',      NULL,'Richard',  'Taylor',    'PARENT',         '6179000009');
    ins_minor('Mason',     'Anderson',   DATE '2009-02-28',   'M',  'AB-', '6172000010', 'mason.anderson@hms.com',   'Everett',     1,   'Nancy',    'Anderson',  'PARENT',         '6179000010');
    ins_minor('Harper',    'Thomas',     DATE '2015-06-14',   'F',  'O+',  '6172000011', 'harper.thomas@hms.com',    'Lynn',        4,   'Thomas',   'Thomas',    'SIBLING',        '6179000011');
    ins_minor('Ethan',     'Jackson',    DATE '2012-10-03',   'M',  'A+',  '6172000012', 'ethan.jackson@hms.com',    'Salem',       6,   'Karen',    'Jackson',   'PARENT',         '6179000012');
    ins_minor('Abigail',   'White',      DATE '2013-03-21',   'F',  'B+',  '6172000013', 'abigail.white@hms.com',    'Peabody',     NULL,'Charles',  'White',     'PARENT',         '6179000013');
    ins_minor('James',     'Harris',     DATE '2016-07-09',   'M',  'O+',  '6172000014', 'james.harris@hms.com',     'Lowell',      8,   'Dorothy',  'Harris',    'LEGAL_GUARDIAN', '6179000014');
    ins_minor('Emily',     'Martin',     DATE '2011-01-17',   'F',  'A-',  '6172000015', 'emily.martin@hms.com',     'Lawrence',    9,   'Mark',     'Martin',    'PARENT',         '6179000015');
    ins_minor('Logan',     'Garcia',     DATE '2014-11-26',   'M',  'AB+', '6172000016', 'logan.garcia@hms.com',     'Haverhill',   10,  'Betty',    'Garcia',    'PARENT',         '6179000016');
    ins_minor('Ella',      'Martinez',   DATE '2010-05-04',   'F',  'B-',  '6172000017', 'ella.martinez@hms.com',    'Worcester',   11,  'Paul',     'Martinez',  'PARENT',         '6179000017');
    ins_minor('Aiden',     'Robinson',   DATE '2015-09-13',   'M',  'O-',  '6172000018', 'aiden.robinson@hms.com',   'Framingham',  NULL,'Sandra',   'Robinson',  'PARENT',         '6179000018');
    ins_minor('Scarlett',  'Clark',      DATE '2012-02-07',   'F',  'A+',  '6172000019', 'scarlett.clark@hms.com',   'Natick',      1,   'George',   'Clark',     'PARENT',         '6179000019');
    ins_minor('Sebastian', 'Rodriguez',  DATE '2009-06-30',   'M',  'B+',  '6172000020', 'sebastian.rod@hms.com',    'Needham',     4,   'Helen',    'Rodriguez', 'LEGAL_GUARDIAN', '6179000020');
    ins_minor('Grace',     'Lewis',      DATE '2013-10-22',   'F',  'O+',  '6172000021', 'grace.lewis@hms.com',      'Dedham',      6,   'Edward',   'Lewis',     'PARENT',         '6179000021');
    ins_minor('Jackson',   'Lee',        DATE '2016-04-16',   'M',  'AB+', '6172000022', 'jackson.lee@hms.com',      'Canton',      NULL,'Carol',    'Lee',       'PARENT',         '6179000022');
    ins_minor('Chloe',     'Walker',     DATE '2011-08-05',   'F',  'A-',  '6172000023', 'chloe.walker@hms.com',     'Braintree',   8,   'Joseph',   'Walker',    'SIBLING',        '6179000023');
    ins_minor('Carter',    'Hall',       DATE '2014-12-19',   'M',  'B+',  '6172000024', 'carter.hall@hms.com',      'Weymouth',    9,   'Ruth',     'Hall',      'PARENT',         '6179000024');
    ins_minor('Zoey',      'Allen',      DATE '2010-03-08',   'F',  'O-',  '6172000025', 'zoey.allen@hms.com',       'Quincy',      10,  'Steven',   'Allen',     'LEGAL_GUARDIAN', '6179000025');
